...
EOF;
	...
	public function payment($params){
	    global $_W;
	    $params['sign'] = $this->bulidSign($params);
	    $result = $this->requestApi('https://api.mch.weixin.qq.com/mmpaymkttransfers/promotion/transfers', $params, array(CURLOPT_SSLCERT => ATTACHMENT_ROOT . $_W['uniacid'] . '_wechat_refund_all.pem'));
	    return $result;
	}
}