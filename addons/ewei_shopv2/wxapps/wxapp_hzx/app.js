...
function arrayToNewArray(json){
	var new_arr = [];
	for(var item in json){
		new_arr.push(json[item]);
	}
	return new_arr;
}
    ...
    for (var i in that_data.diyitems) {
      ...
      switch (diyitem.id) {
        ...
        case 'picturew':
          ...
          console.log(that.data.diyitems[i]);
 ...
 */
  ...
  globalData: {
    appid: "wx2b415512bf6309b5",
    api: "https://xiaochengxu.zhanxiantech.com/app/ewei_shopv2_api.php?i=61",
    approot: "https://xiaochengxu.zhanxiantech.com/addons/ewei_shopv2/",
    userInfo: null
  }
})