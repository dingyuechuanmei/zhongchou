define(['jquery.ui'], function (ui) {
    ...
    modal.init = function (params) {
        ...
        if (!modal.layer) {
            modal.layer = {
                params: {
                    'isopen': '0',
                    'imgurl': '../addons/ewei_shopv2/static/images/pstore.jpg',
                    'linkurl': './index.php?i='+modal.uniacid+'&c=entry&m=ewei_shopv2&do=mobile&r=diypage.location&id=226&preview=1',
    ...
    modal.save = function () {
        ...
        var posturl = biz.url("diypage/shop/location", null, modal.merch);
