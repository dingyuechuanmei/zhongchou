...
$dos = array('category_post', 'category', 'category_del', 'list', 'post', 'batch_post', 'del','list_api','get_detail','case_api','get_case');
...
if ($do == 'post') {
	...
	if (checksubmit()) {
		...
		$data = array(
		    ...
		    'top_thumb' => trim($_GPC['top_thumb']),
		    'top_intro' => trim($_GPC['top_intro']),
