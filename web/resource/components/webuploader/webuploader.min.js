        ...
        return t("dollar-third", [], function() {
            ...
            return r.extend(i.prototype, {
                ...
                fetch: function(e) {
                    ...
                    for (e = e || o.QUEUED, t = 0; t < i; t++) if (n = this._queue[t], e === n.getStatus()) return n;
                    return null
                },
                sort: function(e) {
            ...
            return e.support = function() {
                ...
                predictRuntimeType: function() {
                    var e, n, i = this.options.runtimeOrder || t.orders,
                        r = this.type;
                    if (!r) for (e = 0, n = (i = i.split(/\s*,\s*/g)).length; e < n; e++) if (t.hasRuntime(i[e])) {
                        this.type = r = i[e];
                        break
                    }
                    return r
            ...
            o.extend(t.options, {
                ...
                startUpload: function(t) {
                    ...
                    if (o.each(n.request("get-files", s.INVALID), function() {
                        ...
                        }), t) if ((t = t.id ? t : n.request("get-file", t)).getStatus() === s.INTERRUPT) o.each(n.pool, function(e, n) {
            ...
            return i = {
                ...
                var e = this,
                    t =  40960000//e.options.fileSingleSizeLimit;
                console.log('上传视频', e.options);
                t && e.on("beforeFileQueued", function(e) {
                    if (e.size > t) return e.setStatus(n.Status.INVALID, "exceed_size"), this.trigger("error", "123文件大小超出限制，最大为：" + t / 1048576 + "M", t, e), !1
                })
                    ...
                    if (!(e.byteLength < 6)) {
                        ...
                        if (65496 === s.getUint16(0)) {
                            for (; u < c && ((i = s.getUint16(u)) >= 65504 && i <= 65519 || 65534 === i) && (r = s.getUint16(u + 2) + 2, !(u + r > s.byteLength));) {
                                if (o = t.parsers[i], !n && o) for (a = 0; a < o.length; a += 1) o[a].call(t, s, u, r, f);
                                l = u += r
                            }
            ...
            return n.ExifMap = function() {
                ...
                var a, s, u = i + 10;
                if (1165519206 === t.getUint32(i + 4)) if (u + 8 > t.byteLength) e.log("Invalid Exif data: Invalid segment size.");
            ...
            function i(e) {
                function t(e) {
                    ...
                    for (var s = [1, 1.387039845, 1.306562965, 1.175875602, 1, .785694958, .5411961, .275899379], u = 0, c = 0; c < 8; c++) for (var l = 0; l < 8; l++) S[u] = 1 / (E[H[u]] * s[c] * s[l] * 8), T[u] = 1 / (k[H[u]] * s[c] * s[l] * 8), u++
                }
                function n(e, t) {
            ...
            return t.register("Image", {
                ...
                _resize: function(e, t, n, i) {
                    var r, o, a, s, u, c = this.options,
                        l = e.width,
                        f = e.height,
                        h = this.getOrientation();~ [5, 6, 7, 8].indexOf(h) && (n ^= i, n ^= i ^= n), r = Math[c.crop ? "max" : "min"](n / l, i / f), c.allowMagnify || (r = Math.min(1, r)), o = l * r, a = f * r, c.crop ? (t.width = n, t.height = i) : (t.width = o, t.height = a), s = (t.width - o) / 2, u = (t.height - a) / 2, c.preserveHeaders || this._rotate2Orientaion(t, h), this._renderImageToCanvas(t, e, s, u, o, a)
                },
            ...
            var t = function(e, t) {
                ...
                l = function(e) {
                    ...
                    if (i[t >> 2] |= 128 << (t % 4 << 3), t > 55) for (s(l, i), t = 0; t < 16; t += 1) i[t] = 0;
            ...
            function(e) {
                ...
                var n, i, r, o = t;
                if (e[o >> 2] |= 128 << (o % 4 << 3), o > 55) for (s(this._state, e), o = 0; o < 16; o += 1) e[o] = 0;
                ...
                _initAjax: function() {
                    ...
                    return n.on("uploadprogress progress", function(e) {
                        ...
                        var i, r = n.exec("getStatus"),
                            o = !1,
                            a = "";
                        return n.off(), t._xhr = null, r >= 200 && r < 300 ? o = !0 : r >= 500 && r < 600 ? (o = !0, a = "server") : a = "http", o && (t._response = n.exec("getResponse"), t._response = decodeURIComponent(t._response), i = e.JSON && e.JSON.parse ||
                            function(e) {
                                try {
